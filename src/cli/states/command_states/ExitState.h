...
#ifndef COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_EXITSTATE_H_
#define COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_EXITSTATE_H_
...
#endif //COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_EXITSTATE_H_
