...
#ifndef COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_REMOVECOMPONENT_H_
#define COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_REMOVECOMPONENT_H_

#include <states/StateInterface.h>

class RemoveComponentState : public StateInterface {
 public:
...
#endif //COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_REMOVECOMPONENT_H_
