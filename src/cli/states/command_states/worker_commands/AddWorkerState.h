...
#ifndef COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_ADDWORKERSTATE_H_
#define COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_ADDWORKERSTATE_H_

#include <states/StateInterface.h>

class AddWorkerState : public StateInterface {
 public:
...
#endif //COMPSHOP_SRC_CLI_STATES_COMMAND_STATES_ADDWORKERSTATE_H_
